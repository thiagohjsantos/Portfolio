...
class TextScramble {
    constructor(el) {
      this.el = el
      this.chars = 'ﾊﾐﾋｰｳｼﾅﾓﾆｻﾜﾂｵﾘｱﾎﾃﾏｹﾒｴｶｷﾑﾕﾗｾﾈｽﾀﾇﾍｸ'  // !<>-_\\/[]{}—=+*^?#________  ﾊﾐﾋｰｳｼﾅﾓﾆｻﾜﾂｵﾘｱﾎﾃﾏｹﾒｴｶｷﾑﾕﾗｾﾈｽﾀﾇﾍｸ
  ...
  class TextScramble2 {
    constructor(el) {
      this.el = el
      this.chars = 'XXX'  // !<>-_\\/[]{}—=+*^?#________  ﾊﾐﾋｰｳｼﾅﾓﾆｻﾜﾂｵﾘｱﾎﾃﾏｹﾒｴｶｷﾑﾕﾗｾﾈｽﾀﾇﾍｸ
      this.update = this.update.bind(this)
    }
    setText(newText) {
      const oldText = this.el.innerText
  ...
  class TextScramble3 {
    constructor(el) {
      this.el = el
      this.chars = '01'  // !<>-_\\/[]{}—=+*^?#________  ﾊﾐﾋｰｳｼﾅﾓﾆｻﾜﾂｵﾘｱﾎﾃﾏｹﾒｴｶｷﾑﾕﾗｾﾈｽﾀﾇﾍｸ
      this.update = this.update.bind(this)
    }
    setText(newText) {
      const oldText = this.el.innerText
